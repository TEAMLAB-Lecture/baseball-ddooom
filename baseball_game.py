...
def is_duplicated_number(three_digit):
    ...
    result = (three_digit[0] in three_digit[1:]) or (three_digit[-1] in three_digit[:2])
    # ==================================
    return result
...
def main():
    ...
    while 1:
        ...
        while 1:
            if is_no(answer) or user_input == "0" or is_yes(answer):
                break
        ...
        if is_no(answer) or user_input == "0":    
